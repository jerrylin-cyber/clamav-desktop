export namespace main {
	...
	export class SystemPermissionCheck {
	    ...
	    static createFrom(source: any = {}) {
	        return new SystemPermissionCheck(source);
	    }
	...
	export class SystemPermissionStatus {
	    fullDiskAccess: SystemPermissionCheck;

	    static createFrom(source: any = {}) {
	        return new SystemPermissionStatus(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.fullDiskAccess = this.convertValues(source["fullDiskAccess"], SystemPermissionCheck);
	    }
